...
// const result = await addTransaction(1, 100, "revenu", "2025-03-19", 1, "test");
// if (result.status === 'success') {
//     console.log('Transaction ajoutée avec succès');
// } else {
//     console.error('Erreur lors de l\'ajout de la transaction', result);
// }
  ...
  const fetchTransactions = async () => {
    ...
    try {
      ...
      const transactionsWithCategories = data.map((transaction) => ({
        ...transaction,
        id_categorie: transaction.id_categorie,
